...
public class RentACatUnitTest {
	...
	public void testRenameFailureNumCats0() {
		// TODO: Fill in
		boolean isGarfield = r.renameCat(c2.getId(), "Garfield");
		assertFalse(isGarfield);
		Mockito.verify(c2, Mockito.never()).renameCat("never called");
		assertEquals("Invalid cat ID." + newline, out.toString());
	}
	...
	public void testRenameNumCat3() {
		...
		boolean isGarfield = r.renameCat(2, "Garfield");
		Mockito.verify(c2).renameCat("Garfield");
		assertTrue(isGarfield);
